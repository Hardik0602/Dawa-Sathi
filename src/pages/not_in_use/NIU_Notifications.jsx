...
//     return (
//         <View className='p-1 bg-[#FFFFFF] h-[13%] w-[90%] mb-3 shadow-md shadow-black justify-center items-center rounded-xl'>
//             <Text className={'font-bold text-[21px]'} style={{color: title_color}}>{title}</Text>
